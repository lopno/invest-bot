...
function getHelp(action) {
  return help = 'I can help by answering questions about how your June investment is going. \n' +
    'Tell me the fund you want eg. `opportunity` or `all` to see all funds in combination with one of the following actions: \n' +
    '`graph` + number of days, will give a graph of selected period and fund \n' +
    '`total` will show you the total invested value in the selected fund(s) \n' +
    '`invested` will show the invested value in each separate fund \n' +
    'I\'ll always give a default of how Opportunity is doing, if your message is not understandable.';
}
