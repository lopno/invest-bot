...
function getFundTypesFromMessage(message) {
  const upperMessage = message.toUpperCase();
  const includesTotal = message.toUpperCase('TOTAL');
  ...
  // if (includesTotal) {
  //   result.push(fundType.defensive, fundType.moderateShort, fundType.moderate,
  //   fundType.opportunity, fundType.balanced, fundType.progressive, fundType.opportunity,
  //   fundType.equity);
  // }
